<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.Master" CodeBehind="hideForm.aspx.cs" Inherits="WNC.hideForm" %>
                ...
                xhttp.onreadystatechange = function () {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (result === 'ok') {
                            ...
                            window.location.href = "hideForm.aspx";
                        }
                        else {
                            alert("Ẩn tin thất bạn!!");
                        }
                    }
                };
                xhttp.open("POST", "hideForm.aspx/HideForm", true);
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="post-content mt-0">
                                                ...
                                                <div class="post-meta d-flex">
                                                    <button type="button" class="btn vizew-btn w-100" onclick="hide(<%#Eval("newId")%>)">Ẩn</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
