                ...
                <div class="col-12 col-md-6">
                    <div class="login-content">
                        ...
                        <form id="form2" runat="server">
                            ...
                            <div class="form-group">
                                <asp:TextBox type="password" class="form-control" ID="repassword" placeholder="Re-type password" runat="server"></asp:TextBox>
                                <%--<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">--%>
                            </div>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="repassword"
                                ControlToValidate="password" Display="Dynamic" ErrorMessage="Password doesn't match"></asp:CompareValidator>
                            <div class="form-group">
